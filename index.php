    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="title text-xs-center m-b-30">
                <h2 style="font-weight:bold;">Newest dishes of the Month</h2>
                <p class="lead">Easiest way to order your favourite dishess among these top 6 dishes</p>
            </div>
            <div class="row">
                <?php
                    ...
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="dishes-name">' . $r['slogan'] . '</div>
            ...
            <!-- Top buying -->
            <div class="title text-xs-center m-b-30">
                <h2 style="font-weight:bold;">Most bought dishess</h2>
                <p class="lead">These are the most popular dishess in our shop.</p>
            </div>
            <div class="row">
                <?php
                // $query_res = mysqli_query($db, "SELECT * FROM dishes ORDER BY d_id DESC LIMIT 6");
